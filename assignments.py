...
def problems_assignment_1(current_directory, problem_to_run):
	if problem_to_run==2:
		runpy.run_path(current_directory+"/assignment1/Problem2/problem2numericalanalysis_report1.py")
		print("successfully executed")
	elif problem_to_run==3:
		runpy.run_path(current_directory+"/assignment1/Problem3/problem3numericalanalysis_report1.py")
		print("successfully executed")
	elif problem_to_run==4:
		runpy.run_path(current_directory+"/assignment1/Problem4/problem4numericalanalysis_report1.py")
		print("successfully executed")
	else:
